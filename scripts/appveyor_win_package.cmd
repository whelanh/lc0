...
IF %NAME%==onednn 7z a lc0-%APPVEYOR_REPO_TAG_NAME%-windows-%NAME%.zip C:\cache\dnnl_win_2.2.0_cpu_vcomp\bin\dnnl.dll
...
IF %NAME%==onednn copy "%PKG_FOLDER%\dnnl_win_2.2.0_cpu_vcomp\LICENSE" dist\DNNL-LICENSE
IF %NAME%==onednn copy "%PKG_FOLDER%\dnnl_win_2.2.0_cpu_vcomp\THIRD-PARTY-PROGRAMS" dist\DNNL-THIRD-PARTY-PROGRAMS
