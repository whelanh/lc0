...
type C:\cache\mimalloc-2.0.1\readme.md |more /P > dist\mimalloc-readme.md
type C:\cache\mimalloc-2.0.1\LICENSE |more /P > dist\mimalloc-LICENSE
7z a lc0-%APPVEYOR_REPO_TAG_NAME%-windows-%NAME%.zip C:\cache\mimalloc-2.0.1\out\msvc-x64\Release\mimalloc-override.dll
7z a lc0-%APPVEYOR_REPO_TAG_NAME%-windows-%NAME%.zip C:\cache\mimalloc-2.0.1\out\msvc-x64\Release\mimalloc-redirect.dll
