...
void EncoderBlock<DataType>::Eval(int N, DataType* scratch1, DataType* scratch0,
...

  {
    ...
    cublasXGemmStridedBatched<DataType>(
        ...
        mha_qkv_w, num_inputs, num_inputs * num_outputs, scratch1, num_inputs,
        0, 0.0f, mha_q, num_outputs, num_outputs * batch, 3);
  ...
  */
  ...
  const int encoder_dff = ffn_dense1_size_;
  {
    ...
    addBiasBatched(scratch1, scratch1, ffn_dense1_b, 1, batch, num_outputs, act,
                   stream);
  }
